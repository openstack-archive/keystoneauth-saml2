...
from keystoneauth_saml2 import v3
...
class AuthenticateviaADFSTests(base.TestCase):
    ...
    def setUp(self):
        ...
        self.ADFS_SECURITY_TOKEN_RESPONSE = base.load_xml(
            'ADFS_RequestSecurityTokenResponse.xml')
        self.ADFS_FAULT = base.load_xml('ADFS_fault.xml')
    ...
    def test_prepare_sp_request(self):
        ...
        assertion = assertion.xpath(
            v3.ADFSToken.ADFS_ASSERTION_XPATH,
            namespaces=v3.ADFSToken.ADFS_TOKEN_NAMESPACES)
