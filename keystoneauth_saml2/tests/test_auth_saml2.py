...
class AuthenticateviaSAML2Tests(base.TestCase):
    ...
    def setUp(self):
        ...
        self.saml2plugin = v3.Saml2Token(
            self.TEST_URL,
    ...
    def test_initial_sp_call(self):
        ...
        fixture_soap_response = base.make_oneline(
            saml2_fixtures.SP_SOAP_RESPONSE)

        sp_soap_response = base.make_oneline(
    ...
    def test_send_authn_req_to_idp(self):
        ...
        idp_response = base.make_oneline(etree.tostring(
            self.saml2plugin.saml2_idp_authn_response))

        saml2_assertion_oneline = base.make_oneline(
