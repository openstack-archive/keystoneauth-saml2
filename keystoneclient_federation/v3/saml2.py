...
class Saml2KeystoneUnscoped(_BaseSAMLPlugin):
    ...
    def _get_ecp(self):
        ...
        relay_state = etree.SubElement(
            header, '{urn:oasis:names:tc:SAML:2.0:profiles:SSO:ecp}RelayState')
        ...
        relay_state.text = ('ss:mem:f88cd8ad5aeee3456e74900b306b5ed54e'
                            'c9fb23c614f9fa73ece1c97ec004ed')

        generated_key = etree.SubElement(
            header, '{urn:ietf:params:xml:ns:samlec}GeneratedKey')
        ...
        # TODO(doug-fish): I suspect there is a better way to use lxml to
        # combine these two documents, but I couldn't sort it out.  Resorting
        # to string formatting for now.
