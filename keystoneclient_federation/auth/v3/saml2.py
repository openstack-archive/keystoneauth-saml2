...
from keystoneclient_federation.auth.v3 import federation
...
class _BaseSAMLPlugin(federation.FederatedAuthPlugin):
    ...
    def __init__(self, auth_url,
                 identity_provider, identity_provider_url, **kwargs):
        ...
        super(_BaseSAMLPlugin, self).__init__(
            ...
            identity_provider_url=identity_provider_url, **kwargs)
...
class Saml2Token(_BaseSAMLPlugin):
    ...
    @classmethod
    def get_options(cls):
        options = super(Saml2Token, cls).get_options()
        options.extend([
